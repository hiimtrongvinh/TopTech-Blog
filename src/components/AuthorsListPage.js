...
const storedAuthors = localStorage.getItem("toptech_authors");
const AUTHORS_LIST = storedAuthors ? JSON.parse(storedAuthors) : DEFAULT_AUTHORS;

const AUTHOR_DETAILS = {};
AUTHORS_LIST.forEach(a => {
  AUTHOR_DETAILS[a.name] = {
    avatar: a.avatar,
    role: a.role,
    desc: a.desc
  };
